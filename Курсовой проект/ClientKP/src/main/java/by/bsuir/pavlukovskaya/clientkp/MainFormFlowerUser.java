...
public class MainFormFlowerUser extends javax.swing.JFrame {

    /**
     * Creates new form MainFormFlowerUser
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your han
        dispose();
        AddFormFlowerUser addForm = new AddFormFlowerUser();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(flower != null) {
            dispose();
            AddFormFlowerUser addForm = new AddFormFlowerUser(flower);
            addForm.setVisible(true);
            //            addForm.setLocation(getMousePosition().x, getMousePosition().y);
        }
        else {
